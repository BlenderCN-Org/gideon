...
namespace raytrace {
  ...
  namespace ast {
    ...
    protected:
      ...
      //Generates instructions to propogate the exception value to the calling function.
      void generate_exception_propagate(llvm::Module *module);

      //Generates instructions to report the exception value, and return something undefined. Used for entry functions only.
      void generate_exception_catch(llvm::Module *module);

      //Generates instructions to catch an exception generated by a function call and direct flow to the cleanup blocks.
      llvm::BasicBlock *generate_landing_pad(llvm::Module *module);
